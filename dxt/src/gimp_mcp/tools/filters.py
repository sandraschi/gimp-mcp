    ...
    def register_tools(self, app: FastMCP) -> None:
        ...
        async def apply_blur(
            ...
            try:
                ...
                valid_methods = [
                    "gaussian", "motion", "radial", "pixelize", 
                    "tile", "lens", "selective_gaussian"
                ]
        ...
        async def apply_artistic(
            ...
            try:
                ...
                valid_effects = [
                    "oilify", "cartoon", "softglow", "photocopy", "waterpixels",
                    "newsprint", "clothify", "coffee_stain", "engrave", "jigsaw",
                    "mosaic", "paper_tile", "polar_coords", "ripple", "small_tiles",
                    "tile", "video", "wind", "whirl_pinch"
                ]
