"""
GIMP Installation Detection and Validation.

This module handles cross-platform detection of GIMP installations,
...
class GimpDetector:
    """
    Cross-platform GIMP installation detector and validator.
    """
    ...
    def detect_gimp_installation(self) -> Optional[str]:
        """
        Detect GIMP installation across different platforms.
        
        Returns:
            Optional[str]: Path to GIMP executable if found, None otherwise
        """
        self.logger.info(f"Detecting GIMP installation on {self.system}")
    ...
    def _detect_windows(self) -> Optional[str]:
        ...
        common_paths = [
            ...
            r"C:\Users\{}\AppData\Local\Programs\GIMP 3\bin\gimp-3.0.exe".format(
    ...
    def _check_windows_registry(self) -> Optional[str]:
        """
        Check Windows registry for GIMP installation.
        ...
        try:
            ...
            registry_keys = [
                r"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\GIMP-3_is1",
                r"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\GIMP-2_is1",
                r"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\GIMP-3_is1",
                r"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\GIMP-2_is1",
            ]
