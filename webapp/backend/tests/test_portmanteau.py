...
class TestGimpFileOperations:
    ...
    async def test_file_info(self, temp_image):
        ...
        result = await gimp_file(operation="info", input_path=str(temp_image))
    ...
    async def test_file_load(self, temp_image):
        """Test loading a file."""
        result = await gimp_file(operation="load", input_path=str(temp_image))
        assert result["success"] is True
    ...
    async def test_file_validate(self, temp_image):
        ...
        result = await gimp_file(operation="validate", input_path=str(temp_image))
        assert result["success"] is True

    @pytest.mark.asyncio
    async def test_file_not_found(self):
        """Test handling of missing file."""
        result = await gimp_file(operation="info", input_path="/nonexistent/path/image.jpg")
...
class TestGimpTransformOperations:
    ...
    async def test_resize(self, temp_image, tmp_path):
        ...
        result = await gimp_transform(
            operation="resize", input_path=str(temp_image), output_path=str(output_path), width=100, height=50
        )
        assert result["success"] is True
    ...
    async def test_rotate(self, temp_image, tmp_path):
        ...
        result = await gimp_transform(
            operation="rotate", input_path=str(temp_image), output_path=str(output_path), degrees=90
        )
        assert result["success"] is True
    ...
    async def test_flip(self, temp_image, tmp_path):
        ...
        result = await gimp_transform(
            operation="flip", input_path=str(temp_image), output_path=str(output_path), direction="horizontal"
        )
        assert result["success"] is True
...
class TestGimpColorOperations:
    ...
    async def test_desaturate(self, temp_image, tmp_path):
        ...
        result = await gimp_color(operation="desaturate", input_path=str(temp_image), output_path=str(output_path))
        assert result["success"] is True
...
class TestGimpFilterOperations:
    ...
    async def test_blur(self, temp_image, tmp_path):
        ...
        result = await gimp_filter(operation="blur", input_path=str(temp_image), output_path=str(output_path), radius=5)
        assert result["success"] is True
    ...
    async def test_sharpen(self, temp_image, tmp_path):
        ...
        result = await gimp_filter(operation="sharpen", input_path=str(temp_image), output_path=str(output_path))
        assert result["success"] is True
...
class TestGimpAnalysisOperations:
    ...
    async def test_quality_analysis(self, temp_image):
        ...
        result = await gimp_analysis(operation="quality", input_path=str(temp_image))
        assert result["success"] is True
        assert "data" in result
    ...
    async def test_statistics(self, temp_image):
        ...
        result = await gimp_analysis(operation="statistics", input_path=str(temp_image))
        assert result["success"] is True

    @pytest.mark.asyncio
    async def test_histogram(self, temp_image):
        """Test histogram extraction."""
        result = await gimp_analysis(operation="histogram", input_path=str(temp_image))
        assert result["success"] is True
