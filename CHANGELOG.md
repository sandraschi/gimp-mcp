...
### Added
- Fleet E2E smoke script (`scripts/fleet_e2e_smoke.py`)
- MCPB release workflow (tag `v*` uploads `.mcpb`)
- Avatar HTTP API import path in `fleet_sim_handoff`
- Webapp Sim Art auto-import fields

### Changed
- robotics-mcp / avatar-mcp integration via HTTP (documented in fleet docs)
