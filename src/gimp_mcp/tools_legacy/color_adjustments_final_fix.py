...
class ColorAdjustmentTools(BaseToolCategory):
    ...
    async def _adjust_brightness_contrast_impl(
        ...
        try:
            ...
            logger.info(f"Settings: brightness={brightness}, contrast={contrast}, preserve_colors={preserve_colors}")
            ...
            return self.create_success_response(
                {
                    ...
                    "settings": {"brightness": brightness, "contrast": contrast, "preserve_colors": preserve_colors},
