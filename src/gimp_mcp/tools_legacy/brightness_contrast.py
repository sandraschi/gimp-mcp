    ...
    def register_tools(self, mcp: FastMCP) -> None:
        ...
        @mcp.tool(
            ...
            returns={
                ...
                "properties": {
                    ...
                    "brightness": {"type": "number", "description": "The applied brightness value"},
                    "contrast": {"type": "number", "description": "The applied contrast value"},
                    "output_path": {
                        "type": "string",
                        "format": "file-path",
                        "description": "Path to the processed image",
                    },
                    "output_size": {"type": "integer", "description": "Size of the output file in bytes"},
                    "preserve_colors": {"type": "boolean", "description": "Whether color preservation was enabled"},
                },
        ...
        async def adjust_brightness_contrast(
            ...
            try:
                ...
                logger.error(f"Brightness/contrast adjustment failed: {e!s}", exc_info=True)
                return {
                    "success": False,
                    "error": str(e),
                    "brightness": brightness,
