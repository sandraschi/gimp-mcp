    ...
    def register_tools(self, app) -> None:
        ...
        async def create_layer(
            ...
            try:
                ...
                if layer_type not in valid_types:
                    return self.create_error_response(f"Invalid layer type. Must be one of: {', '.join(valid_types)}")
                ...
                if len(result_parts) >= 2:
                    ...
                    return self.create_success_response(
                        data={"layer_name": layer_name, "layer_index": layer_index, "image_path": image_path},
        ...
        async def merge_layers(
            ...
            try:
                ...
                return self.create_error_response(f"Failed to merge layers: {e!s}")
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_order": [3, 2, 1, 0]},
                }
            ],
        )
        async def reorder_layers(image_path: str, layer_order: list[int]) -> dict[str, Any]:
            """
            ...
            try:
                ...
                return self.create_success_response(
                    data={"reordered": reordered, "image_path": image_path, "new_order": new_order},
                ...
                return self.create_error_response(f"Failed to reorder layers: {e!s}")
        ...
        async def set_layer_visibility(
            ...
            try:
                ...
                return self.create_success_response(
                    data={"layers_modified": modified_count, "image_path": image_path, "visibility": visibility},
                    message=f"Updated visibility for {modified_count} layers",
                )

            except Exception as e:
                self.logger.error(f"Error setting layer visibility: {e}", exc_info=True)
                return self.create_error_response(f"Failed to set layer visibility: {e!s}")
        ...
        @app.tool(
            ...
            parameters={
                ...
                "invert": {"type": "boolean", "description": "Whether to invert the mask", "default": False},
            },
            returns={
                "type": "object",
                "properties": {
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_index": 0, "mask_type": "white"},
                },
                {
        ...
        async def create_layer_mask(
            ...
            try:
                ...
                return self.create_error_response(f"Failed to create layer mask: {e!s}")
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_indices": [0, 2]},
                },
                {
                    "description": "Show only specified layers and hide others",
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_indices": [1], "affect_others": "hide"},
                },
            ],
        )
        async def toggle_layer_visibility(
            ...
            try:
                ...
                return self.create_error_response(f"Failed to toggle layer visibility: {e!s}")
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_indices": [0, 2], "opacity": 50},
                },
                {
        ...
        async def set_layer_opacity(
            ...
            try:
                ...
                return self.create_success_response(
                    data={"layers_modified": modified_count, "image_path": image_path, "opacity": opacity},
                ...
                return self.create_error_response(f"Failed to set layer opacity: {e!s}")
        ...
        async def set_layer_blend_mode(
            ...
            try:
                ...
                if blend_mode_lower not in blend_mode_map:
                    ...
                    return self.create_error_response(f"Invalid blend mode. Must be one of: {valid_modes}")
                ...
                return self.create_success_response(
                    data={"layers_modified": modified_count, "image_path": image_path, "blend_mode": blend_mode},
                ...
                return self.create_error_response(f"Failed to set layer blend mode: {e!s}")
        ...
        @app.tool(
            ...
            parameters={
                ...
                "group_name": {"type": "string", "description": "Name for the new layer group", "default": "Group"},
                "position": {
                    "type": "integer",
        ...
        async def group_layers(
            ...
            try:
                ...
                return self.create_error_response(f"Failed to group layers: {e!s}")
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "group_index": 2},
                },
                {
        ...
        async def ungroup_layers(
            ...
            try:
                ...
                return self.create_error_response(f"Failed to ungroup layers: {e!s}")
            ...
            examples=[
                {
                    ...
                    "parameters": {"image_path": "/path/to/image.xcf", "layer_indices": [2], "count": 1},
                },
                {
        ...
        async def duplicate_layers(
            ...
            try:
                ...
                try:
                    ...
                    return self.create_success_response(
                        data={"duplicated_layers": parsed_results, "image_path": image_path},
                ...
                return self.create_error_response(f"Failed to duplicate layers: {e!s}")
