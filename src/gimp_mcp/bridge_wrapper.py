...
class GimpBridgeWrapper:
    ...
    async def is_alive(self) -> bool:
        ...
        try:
            ...
            _reader, writer = await asyncio.wait_for(asyncio.open_connection(self.host, self.port), timeout=1.0)
            writer.close()
    ...
    async def execute_live_python(self, code: str, timeout: int | None = None) -> dict:
        """
