"""
GIMP CLI Wrapper for executing GIMP operations via command line.

This module provides a robust interface for executing GIMP batch operations
...
class GimpCliError(Exception):
    """Base exception for GIMP CLI operations."""

    pass


class GimpTimeoutError(GimpCliError):
    """GIMP operation timed out."""

    pass


class GimpExecutionError(GimpCliError):
    """GIMP execution failed."""

    pass


class GimpCliWrapper:
    """
    Cross-platform GIMP command-line interface wrapper.

    Provides a high-level interface for executing GIMP batch operations
    ...
    async def execute_script_fu(self, script_content: str, timeout: int | None = None) -> str:
        """
    ...
    async def execute_python_fu(self, python_content: str, timeout: int | None = None) -> str:
        """
