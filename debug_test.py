...
try:
    ...
    print('✅ GimpMCPServer instance created')
    ...
    if hasattr(file_ops, 'register_tools'):
        print('✅ FileOperationTools has register_tools method')
    else:
        print('❌ FileOperationTools missing register_tools method')
